#!/usr/bin/env python3
"""Test long route with extended timeout"""
...
async def test_long_route():
    ...
    print(f"Testing long route with extended timeout")
    ...
    print("\nStarting route search (this may take several minutes)...")
    print("Max iterations increased to 10,000,000")
    ...
    try:
        ...
        if not path:
            ...
            # Print any available debug info
            if stats:
