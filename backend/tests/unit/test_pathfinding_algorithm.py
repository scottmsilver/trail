...
class TestPathfindingAlgorithm:
    ...
    def test_straight_path_flat_terrain(self, mock_dem_cache):
    ...
    def test_avoid_high_cost_obstacle(self, mock_dem_cache):
    ...
    def test_prefer_low_cost_path(self, mock_dem_cache):
    ...
    def test_steep_slope_avoidance(self, mock_dem_cache):
    ...
    def test_impossible_path(self, mock_dem_cache):
    ...
    def test_heuristic_admissibility(self, mock_dem_cache):
